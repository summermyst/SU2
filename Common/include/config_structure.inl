...
inline su2double CConfig::GetBacktracking_Coefficient(void) { return Backtracking_Coefficient; }

inline void CConfig::SetRelaxation_Factor_Flow(su2double val_factor) { Relaxation_Factor_Flow = val_factor; }
